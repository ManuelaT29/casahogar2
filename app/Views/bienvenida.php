		...
		<div class="container-fluid">
			<div class="row d-flex justify-content-center mt-4">
				<div class="col-12 col-md-6">
					<h3 class="text-center fw-bold text-center fuente2">Hogar de animales AnimalPets</h3>
					<p class="text-center fuente2">
              			Casa hogar AnimalPets, atiende desde 1996 animales y fauna silvestre en estado de abandono, ofreciendo atención integral, además somos fabricantes de comida y accesorios para todo tipo de mascota
            		</p>
				</div>
			</div>
		...
		<div class="container mb-5">
			<div class="row mt-5">
				...
				<div class="col-12 col-md-6 align-self-center">
					...
					<h2 class="fuente2 fw-bold">Hogar AnimalPets</h2>
					<p class="fuente2">
